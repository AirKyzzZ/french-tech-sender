    ...
    return (
        <div className="flex flex-col items-center text-center w-full max-w-5xl my-24 mx-auto z-40 relative">
            ...
            <BlurText
                ...
                className="text-3xl sm:text-5xl lg:text-6xl xl:text-7xl bg-gradient-to-br from-foreground to-foreground/60 bg-clip-text text-transparent py-2 md:py-0 leading-tight lg:!leading-[1.15] font-medium tracking-[-0.0125em] mt-6 font-heading"
            />
            <Container delay={0.1}>
